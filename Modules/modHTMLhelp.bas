...
'Copyright © edwinSotware 2007-2008
Option Explicit
...
Public Function HHShowSearch(lhWnd As Long)
    ...
    With HHFQ
        ...
        .pszWindow = ""
    End With
    HTMLHelpCallSearch lhWnd, App.Path & "\payrollsystem.chm" & ">Main", HH_DISPLAY_SEARCH, HHFQ
End Function

'----------SHOW HTMLHELP CONTENTS----------'
Public Function HHShowContents(lhWnd As Long)
    HTMLHelp lhWnd, App.Path & "\payrollsystem.chm" & ">Main", HH_DISPLAY_TOC, 0
End Function

'----------SHOW HTMLHELP INDEX----------'
Public Function HHShowIndex(lhWnd As Long)
    HTMLHelp lhWnd, App.Path & "\payrollsystem.chm" & ">Main", HH_DISPLAY_INDEX, 0
End Function

'----------SHOW HTMLHELP TOPIC----------'
Public Function HHShowTopic(lhWnd As Long, lngTopicID As Long)
    HTMLHelp lhWnd, App.Path & "\payrollsystem.chm" & ">Main", HH_HELP_CONTEXT, lngTopicID
End Function
