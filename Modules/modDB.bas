...
Public cnBank As New Connection 'used by Cash desbursement
Public cnRef As New Connection 'use by reference
...
'[===============================]
  ...
  Load mdiCashAcct 'MDIPayroll
  mdiCashAcct.show 'MDIPayroll.show
End Sub
