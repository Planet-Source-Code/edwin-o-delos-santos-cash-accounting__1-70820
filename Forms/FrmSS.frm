...
Begin VB.Form FrmSS 
   Appearance      =   0  'Flat
   BackColor       =   &H00E0E0E0&
   Caption         =   "Payroll Systsem -  (Print Only)"
   ClientHeight    =   8910
   ClientLeft      =   60
   ClientTop       =   420
   ClientWidth     =   12675
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmSS.frx":157B9
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmSS.frx":15913
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin VB.PictureBox Fraentry 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.CommandButton cmdPrint 
            ...
            Height          =   495
            Left            =   4080
            MouseIcon       =   "FrmSS.frx":15A6D
            MousePointer    =   99  'Custom
            Picture         =   "FrmSS.frx":16337
            Style           =   1  'Graphical
            TabIndex        =   53
            ToolTipText     =   "Print"
            Top             =   3840
...
On Error Resume Next
  If WindowState <> vbMinimized Then
       If Me.Width < 12795 Then Me.Width = 12795
       If Me.Height < 9420 Then Me.Height = 9420
...
'          tbMenu.Width = ScaleWidth
          ...
          ListView1.Height = Me.ScaleHeight - (Fraentry.Height + 900)
